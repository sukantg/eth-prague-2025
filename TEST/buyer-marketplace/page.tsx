...
import { Star, Search, Heart, ShoppingCart, CheckCircle, ArrowLeft, Package, Calendar, User } from "lucide-react"
...
export default function BuyerMarketplace() {
  ...
  if (!isVerified) {
    return <VerificationScreen onVerified={() => setIsVerified(true)} userType="buyer" />
  }
